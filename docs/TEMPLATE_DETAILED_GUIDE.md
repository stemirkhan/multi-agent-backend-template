...
Сейчас `scripts/verify.sh` делает 6 проверок.
...
### 3. Project stack profile is present and valid
...
### 4. README references verify entrypoint
...
### 5. Default phase artifacts are present
...
### 6. Project skills are present and valid
